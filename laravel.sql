-- --------------------------------------------------------
-- Servidor:                     127.0.0.1
-- Versão do servidor:           10.1.44-MariaDB - mariadb.org binary distribution
...
-- Copiando estrutura do banco de dados para laravelcep
CREATE DATABASE IF NOT EXISTS `laravelcep` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `laravelcep`;

-- Copiando estrutura para tabela laravelcep.cidades
CREATE TABLE IF NOT EXISTS `cidades` (
  `id_cidade` int(11) NOT NULL,
  `nome_cidade` varchar(100) NOT NULL,
  `id_estado` int(11) NOT NULL,
  PRIMARY KEY (`id_cidade`),
  KEY `fk_cidades_estados1` (`id_estado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela laravelcep.cidades: ~9.550 rows (aproximadamente)
...
-- Copiando estrutura para tabela laravelcep.endereco
...
-- Copiando dados para a tabela laravelcep.endereco: 0 rows
/*!40000 ALTER TABLE `endereco` DISABLE KEYS */;
/*!40000 ALTER TABLE `endereco` ENABLE KEYS */;

-- Copiando estrutura para tabela laravelcep.estados
...
-- Copiando dados para a tabela laravelcep.estados: ~27 rows (aproximadamente)
...
-- Copiando estrutura para tabela laravelcep.migrations
...
-- Copiando dados para a tabela laravelcep.migrations: 1 rows
/*!40000 ALTER TABLE `migrations` DISABLE KEYS */;
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	(1, '2021_12_17_190358_cria_tabela_endereco', 1);
